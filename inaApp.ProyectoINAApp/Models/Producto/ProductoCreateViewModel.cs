...
namespace inaApp.ProyectoINAApp.Models.Producto
{
    public class ProductoCreateViewModel
    {
        ...
        //public int CategoriaId { get; set; } = 1; //por mientras lo llenamos con uno ya que el profe no tiende category

        //Esto se usa para llenar el dropdownlist(El combobox) de categorias en la vista, se llena desde el controller y se pasa a la vista
        [Display(Name = "Categoría")]
        [Required(ErrorMessage = "Debe seleccionar una categoría.")]
        public int CategoriaId { get; set; }

        // desde el controller y se pasa a la vista para llenar el dropdownlist(El combo) de categorias
